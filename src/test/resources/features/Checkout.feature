...
Feature: Checkout Functionality
  ...
  Scenario: Verify checkout without login
    ...
    And the user enters registration details
      ...
      | Samiha    | Muhabathulla | tamilkumardivya012302@gmail.com | 9876543210 | Test@123 | Test@123        | ABC Company | 12 Main Street | Near Bus Stand | Chennai | 600001   | India   | Tamil Nadu |
